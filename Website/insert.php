...
if (isset($_GET['vacan']) && isset($_GET['vacansf']) && isset($_GET['pativa']) && isset($_GET['pativasf']) && isset($_GET['fp']) && isset($_GET['fpsf']) && isset($_GET['energia']) && isset($_GET['energiasf']) && isset($_GET['pva']) && isset($_GET['pvasf'])) {
    ...
    $result = mysql_query("INSERT INTO inversor2 (data,hora,vacan,vacansf,pativa,pativasf,fp,fpsf,energia,energiasf,pva,pvasf) VALUES('$data','$hora','$vacan','$vacansf','$pativa','$pativasf','$fp','$fpsf','$energia','$energiasf','$pva','$pvasf')");

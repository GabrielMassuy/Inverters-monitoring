...
<head> <title>Potência Ativa</title>
  <meta charset="utf-8">
  ...
  <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    <h3 align="center">Potência Ativa CA</h3>
...
function drawBackgroundColor() {
      ...
      data.addColumn('number', 'Potência Ativa');
      ...
      data.addRows(720);
		...
		for ($ii = 0; $ii< 720; $ii++) {
			...
			data.setValue(<?php echo $ii ?>, 1, <?php echo $pativa[$k - 720 + $ii]*(10**($pativasf[$k - 720 + $ii])) ?>);
			<?php
			}
			?>
